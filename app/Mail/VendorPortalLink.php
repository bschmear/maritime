...
/**
 * Staff-initiated email with links for the manufacturer (vendor) portal — warranty claims, etc.
 */
class VendorPortalLink extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Your manufacturer portal — '.$this->tenantSenderDisplayName(),
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'emails.vendor-portal-link',
            with: [
