...
class CreateServiceTicketServiceItem
{
    public function __invoke(array $data): array
    {
        ...
        try {
            ...
            Log::error('Database query error in CreateServiceTicketServiceItem', [
                'error' => $e->getMessage(),
                'data' => $data
            ]);
            return [
            ...
            Log::error('Unexpected error in CreateServiceTicketServiceItem', [
                'error' => $e->getMessage(),
                'data' => $data
            ]);
            return [
