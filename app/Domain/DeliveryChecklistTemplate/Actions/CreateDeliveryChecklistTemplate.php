...
class CreateDeliveryChecklistTemplate
{
    public function __invoke(array $data): array
    {
        ...
        try {
            ...
            Log::error('Database query error in CreateDeliveryChecklistTemplate', [
                'error' => $e->getMessage(),
                'data' => $data
            ]);
            return [
            ...
            Log::error('Unexpected error in CreateDeliveryChecklistTemplate', [
                'error' => $e->getMessage(),
                'data' => $data
            ]);
            return [
