    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                (\class_exists('Pdo\\Mysql', false) ? \Pdo\Mysql::ATTR_SSL_CA : \PDO::MYSQL_ATTR_SSL_CA) => env('MYSQL_ATTR_SSL_CA'),
            ]) : [],
        ],
        ...
        // Add this tenant connection - it mirrors pgsql but will be dynamically configured
        'tenant' => [
            'driver' => 'pgsql',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST', '127.0.0.1'),
            ...
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public', // This will be overridden per tenant
            'sslmode' => 'prefer',
        ],
