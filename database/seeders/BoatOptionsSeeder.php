 ...
 * `select` (pick one). Standalone add-ons remain toggles. All seeded options are marked global.
 *
 * Run for one tenant (UUID or 1-based account number):
 ...
 */
class BoatOptionsSeeder extends Seeder
{
