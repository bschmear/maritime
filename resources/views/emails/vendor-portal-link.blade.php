...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; padding: 12px 22px; background: #0f766e; color: #fff !important; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px; margin-right: 10px; margin-bottom: 10px; }
...
<body>
    <div class="card">
        ...
        <p><strong>{{ $senderDisplayName }}</strong> invited you to use our <strong>manufacturer portal</strong>, where you can review and respond to warranty claims for your organization.</p>
        ...
        <div class="note">
            <strong>Note:</strong> Your service provider must enable <strong>manufacturer portal access</strong> on your contact record for each vendor before you can open claims. If you sign in but do not see claims, contact them to turn on access.
        </div>
