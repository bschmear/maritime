...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; padding: 12px 22px; background: #0284c7; color: #fff !important; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px; margin-top: 16px; }
