...
<template>
    <Head title="Vendor Portal - Sign In" />
        ...
        <div class="relative max-w-md w-full">
            <div class="text-center mb-8">
                <div class="mx-auto w-14 h-14 bg-primary-600 rounded-xl flex items-center justify-center mb-4">
                    <span class="material-icons text-white text-2xl">precision_manufacturing</span>
                </div>
                <h1 class="text-2xl font-bold text-gray-900 mb-1">Vendor Portal</h1>
                <p class="text-gray-500 text-sm">Sign in to review manufacturer warranty claims</p>
            </div>
