...
defineProps({
    ...
    companyName: { type: String, default: 'Vendor Portal' },
});
...
const submit = () => {
    form.post(route('vendor.portal.register'), {
...
<template>
    <Head title="Vendor Portal - Create Account" />
    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-gray-50 to-secondary-50 px-4 py-12">
        ...
        <div class="relative max-w-md w-full">
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-gray-900 mb-1">Create Vendor Portal Account</h1>
                <p class="text-gray-500 text-sm">Use the email address your provider has on file for your manufacturer</p>
            </div>
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div class="p-3 bg-primary-50 border border-primary-100 rounded-lg">
                        <p class="text-xs text-primary-700 leading-relaxed">
                            <span class="font-semibold">Note:</span> Your email must match a manufacturer contact we have
                            on file. You will verify your email before accessing claims.
                        </p>
                    </div>
                    ...
                    <div class="text-center pt-4 border-t border-gray-100">
                        <p class="text-sm text-gray-500">
                            ...
                            <Link
                                :href="route('vendor.portal.login')"
