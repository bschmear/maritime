...
const breadcrumbItems = computed(() => {
    return [
        ...
        { label: 'Inventory', href: route(`inventoryitems.index`) },
        {
            label: props.record?.inventoryitem?.display_name ?? 'Item',
            href: route('inventoryitems.show', { 'id': props.record.inventory_item_id }),
        },
        {
