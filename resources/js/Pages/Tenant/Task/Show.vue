...
const breadcrumbItems = computed(() => [
    ...
    { label: props.record?.display_name ?? 'Task' },
]);
...
const confirmDelete = () => {
    ...
    router.delete(route('tasks.destroy', recordIdentifier.value), {
        onFinish: () => {
    ...
    <TenantLayout>
        ...
        <Modal :show="showDeleteModal" @close="cancelDelete" max-width="md">
            <div class="p-6 text-center">
                ...
                <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">Delete Task</h3>
