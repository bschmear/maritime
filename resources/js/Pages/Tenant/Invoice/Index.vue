  ...
  <div class="col-span-full mx-4 mt-4 ">
      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">Invoices</span>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
      <div class="space-y-3 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
        <span class="me-2 rounded-sm bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">Paid</span>
        <h2 class="text-2xl font-bold leading-none text-gray-900 dark:text-white">$76,940</h2>
        <p class="text-gray-500 dark:text-gray-400">350 invoices</p>
      </div>
      <div class="space-y-3 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
        <span class="me-2 rounded-sm bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:bg-red-900 dark:text-red-300">Unpaid</span>
        <h2 class="text-2xl font-bold leading-none text-gray-900 dark:text-white">$23,145</h2>
        <p class="text-gray-500 dark:text-gray-400">64 invoices</p>
      </div>
      <div class="space-y-3 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
        <span class="me-2 rounded-sm bg-yellow-100 px-2.5 py-0.5 text-xs font-medium text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300">Pending</span>
        <h2 class="text-2xl font-bold leading-none text-gray-900 dark:text-white">$7,431</h2>
        <p class="text-gray-500 dark:text-gray-400">14 invoices</p>
      </div>
      <div class="space-y-3 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
        <span class="me-2 rounded-sm bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800 dark:bg-gray-700 dark:text-gray-300">Overdue</span>
        <h2 class="text-2xl font-bold leading-none text-gray-900 dark:text-white">$2,826</h2>
        <p class="text-gray-500 dark:text-gray-400">10 invoices</p>
      </div>
    </div>
  </div>
  <div class="relative col-span-full">
    <div class="mx-4 border-b dark:border-gray-700 border-gray-200">
      <div class="flex flex-col-reverse items-center justify-between pb-4 md:flex-row md:space-x-4">
        <div class="flex w-full flex-col space-y-3 md:flex-row md:items-center md:space-y-0 lg:w-2/3">
          <form class="w-full flex-1 md:mr-4 md:max-w-sm">
            ...
            <div class="relative">
              ...
              <input
                type="search"
                id="default-search"
                class="block w-full min-w-64 rounded-lg border border-gray-300 bg-gray-50 p-2 ps-9 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
          ...
          <div class="flex items-center space-x-4">
            <div>
              ...
              <!-- Dropdown menu -->
              <form action="#" method="get" id="filterDropdown" class="z-10 hidden w-80 space-y-4 rounded-lg bg-white p-4 shadow-sm dark:bg-gray-700" aria-labelledby="dropdownDefault">
                <h5 id="drawer-label" class="inline-flex items-center font-medium text-gray-500 dark:text-gray-400">Filter</h5>
                ...
                <div>
                  ...
                  <ul class="grid w-full grid-cols-2 gap-3">
                    <li>
                      <input type="checkbox" id="gaming" name="category" value="" class="peer hidden" />
                      <label
                        for="gaming"
                        class="inline-flex w-full cursor-pointer items-center justify-center rounded-lg border border-gray-300 bg-gray-50 p-2 text-center text-sm font-medium text-gray-500 hover:border-primary-700 hover:bg-primary-700 hover:text-white peer-checked:border-primary-700 peer-checked:bg-primary-700 peer-checked:text-white dark:border-gray-500 dark:bg-gray-600 dark:text-gray-100 dark:hover:border-primary-600 dark:hover:bg-primary-600 dark:hover:text-white dark:peer-checked:border-primary-600 dark:peer-checked:bg-primary-600"
                      >
                        Paid
                      </label>
                    </li>
                    <li>
                      <input type="checkbox" id="unpaid" name="category" value="" class="peer hidden" checked />
                      <label
                        for="unpaid"
                        class="inline-flex w-full cursor-pointer items-center justify-center rounded-lg border border-gray-300 bg-gray-50 p-2 text-center text-sm font-medium text-gray-500 hover:border-primary-700 hover:bg-primary-700 hover:text-white peer-checked:border-primary-700 peer-checked:bg-primary-700 peer-checked:text-white dark:border-gray-500 dark:bg-gray-600 dark:text-gray-100 dark:hover:border-primary-600 dark:hover:bg-primary-600 dark:hover:text-white dark:peer-checked:border-primary-600 dark:peer-checked:bg-primary-600"
                      >
                    ...
                    <li>
                      <input type="checkbox" id="phone" name="category" value="" class="peer hidden" />
                      <label
                        for="phone"
                        class="inline-flex w-full cursor-pointer items-center justify-center rounded-lg border border-gray-300 bg-gray-50 p-2 text-center text-sm font-medium text-gray-500 hover:border-primary-700 hover:bg-primary-700 hover:text-white peer-checked:border-primary-700 peer-checked:bg-primary-700 peer-checked:text-white dark:border-gray-500 dark:bg-gray-600 dark:text-gray-100 dark:hover:border-primary-600 dark:hover:bg-primary-600 dark:hover:text-white dark:peer-checked:border-primary-600 dark:peer-checked:bg-primary-600"
                      >
                    ...
                    <li>
                      <input type="checkbox" id="tv-monitor" name="category" value="" class="peer hidden" />
                      <label
                        for="tv-monitor"
                        class="inline-flex w-full cursor-pointer items-center justify-center rounded-lg border border-gray-300 bg-gray-50 p-2 text-center text-sm font-medium text-gray-500 hover:border-primary-700 hover:bg-primary-700 hover:text-white peer-checked:border-primary-700 peer-checked:bg-primary-700 peer-checked:text-white dark:border-gray-500 dark:bg-gray-600 dark:text-gray-100 dark:hover:border-primary-600 dark:hover:bg-primary-600 dark:hover:text-white dark:peer-checked:border-primary-600 dark:peer-checked:bg-primary-600"
                      >
                ...
                <div class="mt-6 flex space-x-4">
                  <button
                    type="submit"
                    class="dark: rounded-lg bg-primary-700 px-3 py-2 text-center text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                  >
                    Show 32 Results
                  </button>
                  <button
            ...
            <div>
              <button
                ...
                class="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 md:w-auto"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" fill="currentColor" class="-ms-0.5 me-1.5 h-4 w-4" aria-hidden="true">
                  <path
                    fill-rule="evenodd"
              ...
              <div id="configurationDropdown" class="z-10 hidden w-52 rounded-lg bg-white p-2 shadow-sm dark:bg-gray-700">
                <ul class="space-y-1 pb-3 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="configurationDropdownButton">
                  <li>
                    <div class="flex rounded-md px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">
                      <label class="relative inline-flex w-full cursor-pointer items-center">
                        <input type="checkbox" value="" class="peer sr-only" />
                        <div
                          class="peer h-5 w-9 rounded-full bg-gray-200 after:absolute after:start-[2px] after:top-[2px] after:h-4 after:w-4 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-primary-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:border-gray-500 dark:bg-gray-500 dark:peer-focus:ring-primary-800 rtl:peer-checked:after:translate-x-[-100%]"
                        ></div>
                        <span class="ms-3 text-sm font-medium text-gray-900 dark:text-white">Show ammount</span>
                      </label>
                    </div>
                  </li>
                  <li>
                    <div class="flex rounded-md px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">
                      <label class="relative inline-flex w-full cursor-pointer items-center">
                        ...
                        <div
                          class="peer h-5 w-9 rounded-full bg-gray-200 after:absolute after:start-[2px] after:top-[2px] after:h-4 after:w-4 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-primary-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:border-gray-500 dark:bg-gray-500 dark:peer-focus:ring-primary-800 rtl:peer-checked:after:translate-x-[-100%]"
                        ></div>
                        <span class="ms-3 text-sm font-medium text-gray-900 dark:text-white">Show status</span>
                      </label>
                    </div>
                  </li>
                  <li>
                    <div class="flex rounded-md px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">
                      <label class="relative inline-flex w-full cursor-pointer items-center">
                        ...
                        <div
                          class="peer h-5 w-9 rounded-full bg-gray-200 after:absolute after:start-[2px] after:top-[2px] after:h-4 after:w-4 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-primary-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:border-gray-500 dark:bg-gray-500 dark:peer-focus:ring-primary-800 rtl:peer-checked:after:translate-x-[-100%]"
                        ></div>
                        <span class="ms-3 text-sm font-medium text-gray-900 dark:text-white">Show due date</span>
                      </label>
                    </div>
                  </li>
                  <li>
                    <div class="flex rounded-md px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">
                      <label class="relative inline-flex w-full cursor-pointer items-center">
                        ...
                        <div
                          class="peer h-5 w-9 rounded-full bg-gray-200 after:absolute after:start-[2px] after:top-[2px] after:h-4 after:w-4 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-primary-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:border-gray-500 dark:bg-gray-500 dark:peer-focus:ring-primary-800 rtl:peer-checked:after:translate-x-[-100%]"
                        ></div>
                        <span class="ms-3 text-sm font-medium text-gray-900 dark:text-white">Show start date</span>
                      </label>
                    </div>
                  </li>
                </ul>
                <div>
                  <button
                    type="reset"
                    class="flex w-full items-center justify-center rounded-lg bg-primary-700 px-3 py-2 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                  >
                    Reset
                  </button>
                </div>
    ...
    <div class="mx-4 flex flex-wrap py-4">
      ...
      <div class="flex flex-wrap gap-4">
        ...
        <div class="flex items-center">
          <input
            ...
            class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
          />
          <label for="inline-2-radio" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Unpaid</label>
        </div>
        <div class="flex items-center">
          <input
            id="inline-3-radio"
            ...
            class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
          />
          <label for="inline-3-radio" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Paid</label>
        </div>
        <div class="flex items-center">
          <input
            id="inline-4-radio"
            ...
            class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
          />
          <label for="inline-4-radio" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pending</label>
        </div>
      </div>
    </div>
      ...
      <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
        <thead class="bg-gray-50 text-xs uppercase text-gray-500 dark:bg-gray-700 dark:text-gray-400">
          <tr>
            ...
            <th scope="col" class="whitespace-nowrap px-4 py-3 font-semibold">Invoice ID</th>
        ...
        <tbody>
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846325</a></th>
            <td class="px-4 py-3">Flowbite LLC</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">flowbite@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">02 Mar 2025</td>
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846326</a></th>
            <td class="px-4 py-3">Jese Leos</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">name@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">06 Mar 2025</td>
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846327</a></th>
            <td class="px-4 py-3">Bonnie Green</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">name@company.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">08 Mar 2025</td>
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846328</a></th>
            <td class="px-4 py-3">Themesberg LLC</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">company@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">15 Apr 2025</td>
            ...
            <td class="whitespace-nowrap px-4 py-3">
              <span class="mr-2 rounded-sm bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800 dark:bg-gray-700 dark:text-gray-300">Overdue</span>
            </td>
            <td class="px-4 py-3">
              <button
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846329</a></th>
            <td class="px-4 py-3">Micheal Gough</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">name@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">18 Apr 2025</td>
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846330</a></th>
            <td class="px-4 py-3">Lana Byrd</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">name@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">21 Apr 2025</td>
            ...
            <td class="px-4 py-3">
              <button
                id="invoice-6-dropdown-button"
                type="button"
                data-dropdown-toggle="invoice-6-dropdown"
                class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-width="4" d="M6 12h0m6 0h0m6 0h0" />
              ...
              <div id="invoice-6-dropdown" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="invoice-6-dropdown-button">
                  <li>
                    <a href="../create-invoice" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                      <svg class="me-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846331</a></th>
            <td class="px-4 py-3">Netflix LLC</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">company@example.com</td>
            ...
            <td class="px-4 py-3">
              <button
                id="invoice-7-dropdown-button"
                type="button"
                data-dropdown-toggle="invoice-7-dropdown"
                class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-width="4" d="M6 12h0m6 0h0m6 0h0" />
              ...
              <div id="invoice-7-dropdown" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="invoice-7-dropdown-button">
                  <li>
                    <a href="../create-invoice" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                      <svg class="me-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846332</a></th>
            <td class="px-4 py-3">Leslie Livingston</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">name@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">05 May 2025</td>
            ...
            <td class="px-4 py-3">
              <button
                id="invoice-8-dropdown-button"
                type="button"
                data-dropdown-toggle="invoice-8-dropdown"
                class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-width="4" d="M6 12h0m6 0h0m6 0h0" />
              ...
              <div id="invoice-8-dropdown" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="invoice-8-dropdown-button">
                  <li>
                    <a href="../create-invoice" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                      <svg class="me-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846333</a></th>
            <td class="px-4 py-3">Bergside LLC</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">company@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">29 May 2025</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">02 May 2025</td>
            ...
            <td class="px-4 py-3">
              <button
                id="invoice-9-dropdown-button"
                type="button"
                data-dropdown-toggle="invoice-9-dropdown"
                class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-width="4" d="M6 12h0m6 0h0m6 0h0" />
              ...
              <div id="invoice-9-dropdown" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="invoice-9-dropdown-button">
                  <li>
                    <a href="../create-invoice" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                      <svg class="me-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846334</a></th>
            <td class="px-4 py-3">Robert Brown</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">name@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">17 Jun 2025</td>
            ...
            <td class="px-4 py-3">
              <button
                id="invoice-10-dropdown-button"
                type="button"
                data-dropdown-toggle="invoice-10-dropdown"
                class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-width="4" d="M6 12h0m6 0h0m6 0h0" />
              ...
              <div id="invoice-10-dropdown" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="invoice-10-dropdown-button">
                  <li>
                    <a href="../create-invoice" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                      <svg class="me-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846335</a></th>
            <td class="px-4 py-3">Joseph McFall</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">name@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">19 Jun 2025</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">22 Jun 2025</td>
            ...
            <td class="px-4 py-3">
              <button
                id="invoice-11-dropdown-button"
                type="button"
                data-dropdown-toggle="invoice-11-dropdown"
                class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-width="4" d="M6 12h0m6 0h0m6 0h0" />
              ...
              <div id="invoice-11-dropdown" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="invoice-11-dropdown-button">
                  <li>
                    <a href="../create-invoice" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                      <svg class="me-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846336</a></th>
            <td class="px-4 py-3">Neil Sims</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">name@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">28 Jun 2025</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">31 Jul 2025</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">$284</td>
            <td class="whitespace-nowrap px-4 py-3">
              <span class="mr-2 rounded-sm bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">Paid</span>
            </td>
            <td class="px-4 py-3">
              <button
                id="invoice-12-dropdown-button"
                type="button"
                data-dropdown-toggle="invoice-12-dropdown"
                class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-width="4" d="M6 12h0m6 0h0m6 0h0" />
              ...
              <div id="invoice-12-dropdown" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="invoice-12-dropdown-button">
                  <li>
                    <a href="../create-invoice" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                      <svg class="me-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846337</a></th>
            <td class="px-4 py-3">Roberta Casas</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">name@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">29 Jun 2025</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">01 Jul 2025</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">$7675</td>
            <td class="whitespace-nowrap px-4 py-3">
              <span class="me-2 rounded-sm bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:bg-red-900 dark:text-red-300">Unpaid</span>
            </td>
            <td class="px-4 py-3">
              <button
                id="invoice-13-dropdown-button"
                type="button"
                data-dropdown-toggle="invoice-13-dropdown"
                class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-width="4" d="M6 12h0m6 0h0m6 0h0" />
              ...
              <div id="invoice-13-dropdown" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="invoice-13-dropdown-button">
                  <li>
                    <a href="../create-invoice" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                      <svg class="me-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846338</a></th>
            <td class="px-4 py-3">Pixel LLC</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">company@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">02 Jul 2025</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">05 Jul 2025</td>
            ...
            <td class="px-4 py-3">
              <button
                id="invoice-14-dropdown-button"
                type="button"
                data-dropdown-toggle="invoice-14-dropdown"
                class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-width="4" d="M6 12h0m6 0h0m6 0h0" />
              ...
              <div id="invoice-14-dropdown" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="invoice-14-dropdown-button">
                  <li>
                    <a href="../create-invoice" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                      <svg class="me-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white"><a href="../invoice" class="hover:underline">#1846339</a></th>
            <td class="px-4 py-3">Neil Sims</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">name@example.com</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">07 Jul 2025</td>
            <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">10 Jul 2025</td>
            ...
            <td class="px-4 py-3">
              <button
                id="invoice-15-dropdown-button"
                type="button"
                data-dropdown-toggle="invoice-15-dropdown"
                class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-width="4" d="M6 12h0m6 0h0m6 0h0" />
              ...
              <div id="invoice-15-dropdown" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="invoice-15-dropdown-button">
                  <li>
                    <a href="../create-invoice" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                      <svg class="me-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path
    ...
    <div class="w-full">
      ...
      <div class="relative overflow-hidden">
        <nav class="flex flex-col items-start justify-between space-y-3 p-4 md:flex-row md:items-center md:space-y-0" aria-label="Table navigation">
          <span class="text-sm font-normal text-gray-500 dark:text-gray-400">Showing <span class="font-semibold text-gray-900 dark:text-white">1-15</span> of <span class="font-semibold text-gray-900 dark:text-white">1000</span></span>
...
<div id="deleteInvoiceModal" tabindex="-1" aria-hidden="true" class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-0">
  <div class="relative max-h-full w-full max-w-sm p-4">
    ...
    <div class="relative rounded-lg bg-white p-4 text-center shadow-sm dark:bg-gray-800 sm:p-5">
      ...
      <p class="mb-4 text-gray-500 dark:text-gray-400">You are about to delete this invoice, this cannot be undone.</p>
...
<div id="archiveModal" tabindex="-1" aria-hidden="true" class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-0">
  <div class="relative max-h-full w-full max-w-sm p-4">
    ...
    <div class="relative rounded-lg bg-white p-4 text-center shadow-sm dark:bg-gray-800 sm:p-5">
      ...
      <p class="mb-4 text-gray-500 dark:text-gray-300">You've chosen to archive this invoice. Do you want to continue?</p>
      <div class="flex items-center justify-center space-x-4">
        <button
          data-modal-toggle="archiveModal"
          type="button"
