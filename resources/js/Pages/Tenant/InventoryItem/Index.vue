...
<template>
    ...
    <TenantLayout>
        ...
        <Table :records="records" :schema="schema" :form-schema="formSchema" :fields-schema="fieldsSchema" :enum-options="enumOptions" :record-type="recordType" record-title="Parts & Accessories" plural-title="Parts & Accessories" />
    </TenantLayout>
</template>
