...
<template>
    <Head title="Verify email - Customer Portal" />
        ...
        <div class="relative max-w-md w-full">
            <div class="text-center mb-8">
                <div class="mx-auto mb-4 flex h-16 max-w-[220px] items-center justify-center">
                    ...
                    <div
                        v-else
                        class="mx-auto flex h-14 w-14 items-center justify-center rounded-xl bg-primary-600"
                    >
                ...
                <p class="text-gray-500 text-sm">
                    Before you can access the customer portal, click the verification link we sent to your email address.
                </p>
            </div>
