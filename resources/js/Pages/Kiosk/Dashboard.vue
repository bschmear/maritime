...
<template>
    ...
    <KioskLayout>
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <!-- Total Posts -->
            <div class="overflow-hidden rounded-xl bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-3xl font-semibold text-gray-900 dark:text-white">{{ stats.posts }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="border-t border-gray-200 bg-primary-50 px-6 py-3 dark:border-gray-800 dark:bg-gray-900/50">
            ...
            <div class="overflow-hidden rounded-xl bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow">
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 rounded-lg bg-primary-100 p-3 dark:bg-primary-900/30">
                            <svg class="h-6 w-6 text-primary-600 dark:text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="truncate text-sm font-medium text-gray-600 dark:text-gray-400">Published</dt>
                                <dd class="text-3xl font-semibold text-gray-900 dark:text-white">{{ stats.published_posts }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="border-t border-gray-200 bg-gray-50 px-6 py-3 dark:border-gray-800 dark:bg-gray-900/50">
                    <Link :href="route('kiosk.posts.index', { published: true })" class="text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
                        View published
                    </Link>
                </div>
            </div>
            ...
            <div class="overflow-hidden rounded-xl bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow">
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 rounded-lg bg-gray-100 p-3 dark:bg-gray-800">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-3xl font-semibold text-gray-900 dark:text-white">{{ stats.categories }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="overflow-hidden rounded-xl bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="truncate text-sm font-medium text-gray-600 dark:text-gray-400">Tags</dt>
                                <dd class="text-3xl font-semibold text-gray-900 dark:text-white">{{ stats.tags }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="border-t border-gray-200 bg-primary-50 px-6 py-3 dark:border-gray-800 dark:bg-gray-900/50">
                    <Link :href="route('kiosk.tags.index')" class="text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
                        Manage tags
                    </Link>
                </div>
            </div>
