...
const form = useForm({
    ...
    featured: props.faq.featured || false,
});

const submit = () => {
    form.put(route('kiosk.faqs.update', props.faq.id));
};
</script>
    ...
    <KioskLayout>
        <template #header>
            <div class="flex items-center gap-x-3">
                ...
                <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Edit FAQ</h1>
            </div>
        </template>
        ...
        <form @submit.prevent="submit" class="space-y-8">
            <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3">
                ...
                <div class="px-4 sm:px-0">
                    <h2 class="text-base font-semibold leading-7 text-gray-900 dark:text-white">FAQ Information</h2>
                ...
                <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-sm rounded-xl md:col-span-2">
                    <div class="px-4 py-6 sm:p-8">
                        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8">
                            <!-- Question Field -->
                            <div>
                                <InputLabel for="question" value="Question" class="text-gray-900 dark:text-white" />
                                <TextInput
                                    id="question"
                            ...
                            <!-- Answer Field -->
                            <div>
                                <InputLabel for="answer" value="Answer" class="text-gray-900 dark:text-white" />
                                <textarea
                                    v-model="form.answer"
                                    id="answer"
                                    rows="6"
                            ...
                            <div>
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3">
                                        <InputLabel for="featured" value="Featured" class="text-gray-900 dark:text-white" />
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            Display this FAQ on home page.
                                        </p>
                                    </div>
                                </div>
