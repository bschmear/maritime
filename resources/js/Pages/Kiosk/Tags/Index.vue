...
const deleteTag = (tag) => {
    if (confirm(`Delete "${tag.name}"?`)) {
        router.delete(route('kiosk.tags.destroy', tag.id));
    }
};
</script>
    ...
    <KioskLayout>
        ...
        <div class="space-y-6">
            ...
            <div class="overflow-hidden bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-sm rounded-xl">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900">
                            ...
                            >
                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium sm:pl-6">
                                    <span class="inline-flex items-center rounded-md bg-gray-100 dark:bg-gray-800 px-2.5 py-1 text-xs font-medium text-gray-700 dark:text-gray-300 ring-1 ring-inset ring-gray-500/10 dark:ring-gray-500/20">
                                        {{ tag.name }}
                                    </span>
                                </td>
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                    <div class="flex items-center justify-end gap-x-3">
                                        <Link
                                            :href="route('kiosk.tags.edit', tag.id)"
                ...
                <!-- Pagination -->
                <div v-if="tags.data && tags.data.length > 0 && (tags.prev_page_url || tags.next_page_url)" class="border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 px-4 py-3 sm:px-6">
