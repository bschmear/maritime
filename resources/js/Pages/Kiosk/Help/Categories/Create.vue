...
<template>
    ...
    <KioskLayout>
        <template #header><h1 class="text-xl font-semibold text-gray-900 dark:text-white">Create Category</h1></template>
        <form class="max-w-xl space-y-4" @submit.prevent="form.post(route('kiosk.help-categories.store'))">
            <div>
            ...
            <div class="flex gap-3">
                <button type="submit" class="gradient-btn rounded-lg px-4 py-2 text-sm">Save</button>
