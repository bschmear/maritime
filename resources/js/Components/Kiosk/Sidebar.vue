...
const navigation = [
    ...
    },
    {
        ...
        icon: 'M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118L6.622 21.75l-1.5-3.75a2.25 2.25 0 012.118-2.247L16.5 12.75M20.25 7.5l-2.625 10.632a2.25 2.25 0 01-2.247 2.118L6.622 21.75M20.25 7.5L16.5 12.75',
        children: [
            { name: 'Brands', href: 'kiosk.inventory-brands.index' },
        ],
    },
    {
        name: 'Posts',
