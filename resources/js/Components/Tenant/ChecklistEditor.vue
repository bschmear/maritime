    ...
    <div class="checklist">
        ...
        <div class="mb-4">
            <div class="flex items-center justify-between mb-1.5">
                ...
                <span class="text-xs font-semibold" :class="progress.pct === 100 ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-400'">
                    {{ progress.pct }}%
                </span>
            </div>
...
const props = defineProps({
    ...
    // Pass saved templates from parent so the picker can list them
    templates: {
        type: Array,
        default: () => [],
    },
...
const checklist = ref(structuredClone(props.modelValue))
...
// Get the real index in checklist.items for a filtered item (needed for removeItem)
...
// Press Enter on an item → jump to next item or create new one
