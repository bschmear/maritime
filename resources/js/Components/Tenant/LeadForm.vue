...
const isFullWidthField = (key) => fieldDef(key).type === 'textarea' || fieldDef(key).type === 'json' || isEnumSelectField(key);

const submitLabel = computed(() => (props.mode === 'edit' ? 'Save changes' : 'Create lead'));
...
<template>
    <div class="w-full flex flex-col space-y-6">
        <form id="lead-form" class="pb-28" @submit.prevent="submit">
