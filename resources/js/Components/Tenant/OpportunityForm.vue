...
const openAddItemModal = () => {
    ...
    lineItemForm.value = { inventory_item_id: null, display_name: '', sku: '', quantity: 1, unit_price: 0, notes: '' };
                ...
                <div class="lg:col-span-8 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-lg sm:rounded-lg overflow-hidden">
                        ...
                        <div v-else class="flex flex-col items-center justify-center py-14 text-center px-6">
                            ...
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">No inventory items added yet</p>
                            <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Click "Add Item" to attach inventory to this opportunity</p>
                        </div>
                    </div>
                </div>
